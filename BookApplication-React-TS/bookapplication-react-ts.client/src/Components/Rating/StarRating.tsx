...
function StarRating({ value, onChange, max = 5 }: StarRatingProps) {
    ...
    return (
        <div className="flex flex-row w-80 mx-auto items-center justify-center py-3">
            {Array.from({ length: max }, (_, i) => i + 1).map((star) => {
                ...
                return (
                    <button
                        ...
                        className="relative text-3xl transition-transform hover:scale-110 focus:outline-none w-8 h-8"
                    >
                        {/* Gray base star */}
